  ...
  return (
    <div className={getClassName([className, "score"])} style={style}>
      <button
        ...
        aria-label="Upvote"
      >
        <svg className="score__svg-plus" width="11" height="11" xmlns="http://www.w3.org/2000/svg">
      ...
      <button
        ...
        aria-label="Downvote"
      >
        <svg className="score__svg-minus" width="11" height="3" xmlns="http://www.w3.org/2000/svg">
